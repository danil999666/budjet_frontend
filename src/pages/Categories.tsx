			...
			<div className='mt-10 p-4 rounded-md bg-slate-800 dark:bg-slate-300'>
				...
				<div className='flex mt-2 items-center gap-2 flex-wrap'>
					{categories.map((category, idx) => (
						<div
							key={idx}
							className='group py-2 px-4 rounded-lg bg-blue-600 dark:bg-orange-600 flex items-center relative gap-2'
						>
							{category.title}
							<div className='absolute hidden px-3 left-0 top-0 bottom-0 right-0 rounded-lg bg-black/90 dark:bg-white/90 items-center justify-between group-hover:flex'>
								<button
									onClick={() => {
